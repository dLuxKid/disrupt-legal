            ...
            {[
              ...
              <Link key={i} href={item.href}>
                <div className="flex flex-col">
                  ...
                  />
                  <div className="p-4 md:p-[18px] space-y-2 bg-primary rounded-sm rounded-t-none relative z-1 -mt-9 md:-mt-12 size-full">
                    ...
                    <p className="flex items-center gap-2 text-base md:text-lg font-bold text-secondary">
                      Learn more
                      <span>
                        <svg
                          width="16"
