    ...
    <main className="flex flex-col gap-5">
      <section className="flex flex-col bg-[url('/about-hero-bg.jpg')] bg-cover bg-center bg-no-repeat min-h-screen relative">
        ...
        <div className="mw px-4 md:px-10 lg:px-20 py-20 lg:py-[170px] relative">
          <div className="w-full space-y-6 max-w-[904px]">
            <h1 className="text-white font-medium text-4xl md:text-[55px]/[65px] lg:text-[60px]/[75px]">
              Empowering innovation through smarter, technology-driven
              compliance.
            </h1>
            <div>
              <Link href={"/services"}>
      ...
      <section className="flex items-center justify-center relative">
        <div className="mw flex flex-col gap-6 md:gap-12 px-4 md:px-10 lg:px-20 py-10 lg:py-[72px]">
          <div className="space-y-[18px]">
            <h4 className="font-medium text-2xl/[34px] md:text-[32px]/[42px] text-black">
              Our Mission
            </h4>
            <p className="text-base/[25px] text-black">
              At disruptLegal, our mission is to bridge the gap between rapidly
              evolving innovation and dynamic regulatory landscapes. We redefine
              compliance by delivering future-ready, technology-driven solutions
              that empower organisations to confidently navigate complexity—far
              beyond traditional legal frameworks.
            </p>
          </div>
          <div className="space-y-[18px]">
            <h4 className="font-medium text-2xl/[34px] md:text-[32px]/[42px] text-black">
            ...
            <p className="text-base/[25px] text-black">
              disruptLegal was founded on the belief that compliance should be a
              catalyst for innovation, not a barrier. We recognized the widening
              gap between fast-moving technologies like blockchain, AI, and
              digital finance, and the slower pace of regulatory understanding.
              Our goal is simple: to merge technical expertise with regulatory
              intelligence, creating agile, adaptive compliance frameworks built
              for the future.
            </p>
          </div>
        </div>
        ...
        <div className="mw flex max-lg:flex-col gap-8 justify-between py-10 lg:py-20 px-4 md:px-10 lg:px-20">
          <div className="space-y-[13px] lg:max-w-[527px]">
            ...
            <p className="text-sm/5 md:text-base/6 font-semibold text-white">
              disruptLegal combines technical expertise, ongoing research, and
              agile collaboration to help you confidently navigate complex
              compliance challenges.
            </p>
          </div>
          <div className="space-y-5 lg:max-w-[548px]">
            {[
              {
                title: "Customised Solutions:",
                desc: "We don’t believe in one-size-fits-all. Every business is unique, so we tailor our advisory to fit your specific technology, industry, and regulatory needs—ensuring practical, effective compliance strategies.",
              },
              {
                title: "Integrated Expertise:",
                desc: "Our team brings together specialists from law, technology, policy, and market research to create comprehensive solutions that address every aspect of your compliance landscape.",
              },
              {
                title: "Proactive Compliance:",
                desc: "We stay ahead of regulatory trends and anticipate changes, so you’re prepared before new rules impact your business—minimizing risk and disruption.",
              },
              {
                title: "Collaborative Partnership:",
                desc: "We work hand-in-hand with you, maintaining open communication and flexibility to adapt as your business evolves and compliance demands shift.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="py-6 md:py-[30px] border-b border-b-background space-y-3 md:space-y-5"
              >
                <h6 className="text-[22px]/8 md:text-[32px]/[42px] font-semibold text-white">
                  {item.title}
                </h6>
                <p className="text-sm/5 md:text-base/6 text-white">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <section className="flex items-center justify-center relative">
        <div className="mw flex flex-col gap-8 md:gap-[50px] px-4 md:px-10 lg:px-20 py-10 lg:py-20">
          ...
          <div className="border-[0.5px] border-foundation-9 w-full flex max-md:flex-col gap-[22px] [&>div]:max-md:border-b-[0.5px] [&>div]:border-b-foundation-9 [&>div]:border-dashed [&>div]:last:border-0 [&>div]:border-r">
            {[
              {
